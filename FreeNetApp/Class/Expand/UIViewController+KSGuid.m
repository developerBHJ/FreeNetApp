...
- (UIButton*)removeBtn{
    ...
    //***********************这里面可以自定义*******************************//
    CGFloat btnW = MainScreen_width / 3 * 2;
    CGFloat btnH = MainScreen_height / 12.9;
    ...
    [removeBtn setTitle:@"开始体验" forState:UIControlStateNormal];
    [removeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    removeBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    removeBtn.backgroundColor = [UIColor colorWithHexString:@"#e4504b"];
