...
- (id)initSheetWithTitle:(NSString *)title
              ...
              itemTitles:(NSArray *)itemTitles distance:(CGFloat)distace
{
...
- (id)upWeiChatStyeWithItems:(NSArray *)itemTitles title:(NSString *)title selfView:(MHActionSheet *)selfView
{
    ...
    selfView.footView.footButton.titleLabel.font = [UIFont systemFontOfSize:12];
    if ([[UIScreen mainScreen] bounds].size.height == 667) {
        selfView.footView.footButton.titleLabel.font = [UIFont systemFontOfSize:12];
    }
    else if ([[UIScreen mainScreen] bounds].size.height > 667) {
        selfView.footView.footButton.titleLabel.font = [UIFont systemFontOfSize:15];
    }
...
- (void)pushDefaultStyeSheetView
{
    ...
    [UIView animateWithDuration:kPushTime animations:^{
        weakSelf.contentView.frame = CGRectMake(kMargin, kWH - self.distance, kMW, weakSelf.contentVH);
        weakSelf.footView.frame = CGRectMake(kMargin, self.contentView.bottom + 10, kMW, kCellH);
...
-(void)showCustomViewOnView:(UIView *)view{

    __weak typeof(self) weakSelf = self;
    [UIView animateWithDuration:0.3 animations:^{
        weakSelf.contentView.frame = CGRectMake(0, 64, kWW, weakSelf.contentVH);
        weakSelf.bgButton.frame = CGRectMake(0, 64, MainScreen_width, MainScreen_height - 64);
        weakSelf.bgButton.alpha = 0.35;
